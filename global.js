...
const endpoints = new Map()
    .set("login", {method: "POST", url: "/auth/token"})
    .set("who", {method: "GET", url: "/auth/me"})
    .set("createClub", {method: "POST", url: "/api/clubs"})
    .set("getAllClubs", {method: "POST", url: "/api/clubs"})
    .set("getClubById", {method: "GET", url: "/api/clubs/{id}"})
    .set("editClubInfo", {method: "PUT", url: "/api/clubs"})
    .set("cities", {method: "GET", url: "/api/cities"})
    .set("changeAttributesOfCity", {method: "PUT", url: "/api/cities"})
    .set("getOwnCity", {method: "GET", url: "/api/clubs/city"})
 ...
 * @param {string|Number} id - Optional. Set if url contains id.
 * @return {Endpoint}
 */
export function getEndpoint(description, id = undefined) {
    const endpoint = endpoints.get(description);
 ...
 * @param {Endpoint} endpoint - Use getEndpoint function
 * @param {Object} body - Optional
 * @return {Promise<Response>}
 */
export function fetchWithToken(endpoint, body = undefined) {
 ...
 * @param {...string} roles - Role like "ADMIN" or "CLUB".
 * @return {void}
 */
export function redirectIfNotLoggedInAs(...roles) {
    if (!roles.includes(sessionStorage.getItem("role"))) {
...
export function fillCountriesAndCities() {
    ...
    countrySelect.addEventListener("change", async event => {
        ...
        labelSelectCity.style.display = "block";
        const citiesOfCountry = await fetch(getEndpoint("cities").url + "?country=" + countrySelect.value).then(response => response.json());
        ...
        newCityOption.value = "createNewCity";
        newCityOption.innerText = "Create new city";
        citySelect.append(newCityOption);
        if (citySelect.value === "createNewCity") {
            labelNewCity.style.display = "block";
        }
        document.dispatchEvent(new Event("citiesLoaded"));
    });
}